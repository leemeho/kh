            ...
            <div class="sticky-content-inner">
              <div class="card card-shadow m-bottom">
               ...
               <div class="page--title ptop--30">
                  <h2 class="h2">Search Results For: <span><?php printf( __( '%s', 'khabarera' ), get_search_query() ); ?></span></h2>
               </div>
                        ...
                        <div class="post--item post--title-larger">
                           <div class="row">
                              ...
                              <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                 ...
                                 <div class="post--action"> <a href="<?php the_permalink() ?>" class="btn-read">Read More</a> </div>
                              </div>
                           </div>
                        </div>
                     </li>
